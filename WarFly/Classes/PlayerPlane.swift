...
class PlayerPlane: SKSpriteNode {
    ...
    static func populate (at point: CGPoint) -> PlayerPlane {
        ...
        let playerPlanePhysicsBodyTexture = SKTexture(imageNamed: "player_physics_body")
        playerPlane.physicsBody = SKPhysicsBody(texture: playerPlanePhysicsBodyTexture, alphaThreshold: 0.2, size: playerPlane.size)

...
class GameScene: ParentScene {
    ...
    override func didMove(to view: SKView) {
        ...
        } else if !gameSettings.isMusic && backgroundMusic != nil {
    ...
    fileprivate func spawnSpiralOfEnemies() {
        ...
        SKTextureAtlas.preloadTextureAtlases([enemyTextureAtlas1, enemyTextureAtlas2]) { [unowned self] in
            ...
            let randomNumber = Int(arc4random_uniform(2))
            let arrayOfAtlses = [enemyTextureAtlas1, enemyTextureAtlas2]
            let textureAtlas = arrayOfAtlses[randomNumber]
    ...
    fileprivate func configureStartScene() {
        ...
        player = PlayerPlane.populate(at: CGPoint(x: screenBounds.size.width/2, y: 100))
